        ...
        <div className="p-4 text-center space-y-6">
          <div className="space-y-6">
            <input
              ...
              autoFocus
              className="w-fit px-8 py-6 border border-gray-300 dark:border-neutral-700 rounded-lg bg-white dark:bg-neutral-800 text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white placeholder-gray-400 dark:placeholder-gray-500 text-center"
            />
          </div>
          ...
          <button
            ...
            className="w-fit px-6 py-4 bg-black dark:bg-white text-white dark:text-black rounded-full text-lg font-medium disabled:opacity-50 active:scale-95 transition-transform touch-manipulation"
          >
